...
TR69_FUNC_TABLE tr69_param[] = {
	...
	{"Device.DeviceInfo.X_CHARTER_COM_SerialNumber", get_DD_X_CHARTER_COM_SerialNumber, 0, ""},
	...
	{"Device.DeviceInfo.DeviceImageNumberOfEntries", get_DD_DeviceImageNumberOfEntries, 0, ""},
	...
	{"Device.DeviceInfo.TemperatureStatus.TemperatureSensorNumberOfEntries", get_DDT_ProcessNumberOfEntries, 0, ""},
	...
	{"Device.ManagementServer.URL", get_DM_URL, set_DM_URL, ""},
	{"Device.ManagementServer.Username", get_DM_Username, set_DM_Username, ""},
	{"Device.ManagementServer.Password", get_DM_Password, set_DM_Password, ""},
	{"Device.ManagementServer.ScheduleReboot", get_DM_ScheduleReboot, set_DM_ScheduleReboot, ""},
	{"Device.ManagementServer.DelayReboot", get_DM_DelayReboot, set_DM_DelayReboot, ""},
	...
	{"Device.ManagementServer.PeriodicInformTime", get_DM_PeriodicInformTime, set_DM_PeriodicInformTime, ""},
	{"Device.ManagementServer.ParameterKey", get_DM_ParameterKey, set_DM_ParameterKey, ""},
	{"Device.ManagementServer.ConnectionRequestURL", get_DM_ConnectionRequestURL, 0, ""},
	{"Device.ManagementServer.ConnectionRequestUsername", get_DM_ConnectionRequestUsername, set_DM_ConnectionRequestUsername, ""},
	{"Device.ManagementServer.ConnectionRequestPassword", get_DM_ConnectionRequestPassword, set_DM_ConnectionRequestPassword, ""},
	...
	{"Device.ManagementServer.X_CHARTER_COM_ACSIdentifier", get_DM_X_CHARTER_COM_ACSIdentifier, set_DM_X_CHARTER_COM_ACSIdentifier, ""},
	{"Device.ManagementServer.HTTPConnectionRequestEnable", get_DM_HTTPConnectionRequestEnable, set_DM_HTTPConnectionRequestEnable, ""},
	...
	{"Device.ManagementServer.X_TWC_COM_ValidateManagementServerCertificate", get_DM_X_TWC_COM_ValidateManagementServerCertificate, set_DM_X_TWC_COM_ValidateManagementServerCertificate, ""},
	{"Device.ManagementServer.X_TWC_COM_ValidateDownloadServerCertificate", get_DM_X_TWC_COM_ValidateDownloadServerCertificate, set_DM_X_TWC_COM_ValidateDownloadServerCertificate, ""},
	{"Device.ManagementServer.X_TWC_COM_RootCertificateNumberOfEntries", get_DM_X_TWC_COM_RootCertificateNumberOfEntries, 0, ""},
	{"Device.ManagementServer.X_TWC_COM_RootCertificate.template.Enabled", get_DMXt_Enabled, set_DMXt_Enabled, ""},
	{"Device.ManagementServer.X_TWC_COM_RootCertificate.template.Certificate", get_DMXt_Certificate, set_DMXt_Certificate, ""},
	{"Device.ManagementServer.X_TWC_COM_RootCertificate.template.LastModif", get_DMXt_LastModif, 0, ""},
	{"Device.ManagementServer.X_TWC_COM_RootCertificate.template.SerialNumber", get_DMXt_SerialNumber, 0, ""},
	{"Device.ManagementServer.X_TWC_COM_RootCertificate.template.Issuer", get_DMXt_Issuer, 0, ""},
	{"Device.ManagementServer.X_TWC_COM_RootCertificate.template.NotBefore", get_DMXt_NotBefore, 0, ""},
	{"Device.ManagementServer.X_TWC_COM_RootCertificate.template.NotAfter", get_DMXt_NotAfter, 0, ""},
	{"Device.ManagementServer.X_TWC_COM_RootCertificate.template.Subject", get_DMXt_Subject, 0, ""},
	{"Device.ManagementServer.X_TWC_COM_RootCertificate.template.SubjectAlt", get_DMXt_SubjectAlt, 0, ""},
	{"Device.ManagementServer.X_TWC_COM_RootCertificate.template.SignatureAlgorithm", get_DMXt_SignatureAlgorithm, 0, ""},
	{"Device.ManagementServer.X_TWC_COM_RootCertificate.template.X_CHARTER_COM_ACSIdentifier", get_DMXt_X_CHARTER_COM_ACSIdentifier, 0, ""},
	...
	{"Device.UserInterface.Enable", get_DU_Enable, set_DU_Enable, ""},
	...
	{"Device.UserInterface.RemoteAccess.X_Charter_AllowSpecifiedIP", get_DUR_X_Charter_AllowSpecifiedIP, set_DUR_X_Charter_AllowSpecifiedIP, ""},
	{"Device.UserInterface.RemoteAccess.X_Charter_AllowedIpRanges", get_DUR_X_Charter_AllowedIpRanges, set_DUR_X_Charter_AllowedIpRanges, ""},
	{"Device.UserInterface.RemoteAccess.X_Charter_MaxAllowedIpRangeNumber", get_DUR_X_Charter_MaxAllowedIpRangeNumber, 0, ""},
	...
	{"Device.UserInterface.X_Charter.ManagerPassword", get_DUX_X_Charter_ManagerPassword, set_DUX_X_Charter_ManagerPassword, ""},
	{"Device.UserInterface.X_Charter.SuperPassword", get_DUX_X_Charter_SuperPassword, set_DUX_X_Charter_SuperPassword, ""},
	...
	{"Device.WiFi.X_Charter_BandSteering.Enable", get_DWX_Charter_BS_Enable, set_DWX_Charter_BS_Enable, ""},
	//{"Device.WiFi.X_Charter_BandSteering.MatchingSSID", get_DWX_Charter_BS_MatchingSSID, set_DWX_Charter_BS_MatchingSSID, ""},
	{"Device.WiFi.X_Charter_BandSteering.PHYBasedPrioritization", get_DWX_Charter_BS_PHYBasedPrioritization, set_DWX_Charter_BS_PHYBasedPrioritization, ""},
	{"Device.WiFi.X_Charter_BandSteering.AgeLimit", get_DWX_Charter_BS_AgeLimit, set_DWX_Charter_BS_AgeLimit, ""},
	{"Device.WiFi.X_Charter_BandSteering.StationDatabase.IncludeOutOfNetwork", get_DWX_Charter_BSS_IncludeOutOfNetwork, set_DWX_Charter_BSS_IncludeOutOfNetwork, ""},
	{"Device.WiFi.X_Charter_BandSteering.StationDatabase.MarkAdvClientAsDualBand", get_DWX_Charter_BSS_MarkAdvClientAsDualBand, set_DWX_Charter_BSS_MarkAdvClientAsDualBand, ""},
	{"Device.WiFi.X_Charter_BandSteering.StationDatabase.AgingSizeThreshold", get_DWX_Charter_BSS_AgingSizeThreshold, set_DWX_Charter_BSS_AgingSizeThreshold, ""},
	{"Device.WiFi.X_Charter_BandSteering.StationDatabase.AgingFrequency", get_DWX_Charter_BSS_AgingFrequency, set_DWX_Charter_BSS_AgingFrequency, ""},
	{"Device.WiFi.X_Charter_BandSteering.StationDatabase.OutOfNetworkMaxAge", get_DWX_Charter_BSS_OutOfNetworkMaxAge, set_DWX_Charter_BSS_OutOfNetworkMaxAge, ""},
	{"Device.WiFi.X_Charter_BandSteering.StationDatabase.InNetworkMaxAge", get_DWX_Charter_BSS_InNetworkMaxAge, set_DWX_Charter_BSS_InNetworkMaxAge, ""},
	{"Device.WiFi.X_Charter_BandSteering.StationDatabase.NumRemoteBSSes", get_DWX_Charter_BSS_NumRemoteBSSes, set_DWX_Charter_BSS_NumRemoteBSSes, ""},
	{"Device.WiFi.X_Charter_BandSteering.StationDatabase.PopulateNonServingPHYInfo", get_DWX_Charter_BSS_PopulateNonServingPHYInfo, set_DWX_Charter_BSS_PopulateNonServingPHYInfo, ""},
	{"Device.WiFi.X_Charter_BandSteering.IdleSteeringSettings.RSSISteeringPoint_DG", get_DWX_Charter_BSI_RSSISteeringPoint_DG, set_DWX_Charter_BSI_RSSISteeringPoint_DG, ""},
	{"Device.WiFi.X_Charter_BandSteering.IdleSteeringSettings.RSSISteeringPoint_UG", get_DWX_Charter_BSI_RSSISteeringPoint_UG, set_DWX_Charter_BSI_RSSISteeringPoint_UG, ""},
	{"Device.WiFi.X_Charter_BandSteering.IdleSteeringSettings.NormalInactTimeout", get_DWX_Charter_BSI_NormalInactTimeout, set_DWX_Charter_BSI_NormalInactTimeout, ""},
	{"Device.WiFi.X_Charter_BandSteering.IdleSteeringSettings.OverloadInactTimeout", get_DWX_Charter_BSI_OverloadInactTimeout, set_DWX_Charter_BSI_OverloadInactTimeout, ""},
	{"Device.WiFi.X_Charter_BandSteering.IdleSteeringSettings.InactCheckInterval", get_DWX_Charter_BSI_InactCheckInterval, set_DWX_Charter_BSI_InactCheckInterval, ""},
	{"Device.WiFi.X_Charter_BandSteering.IdleSteeringSettings.AuthAllow", get_DWX_Charter_BSI_AuthAllow, set_DWX_Charter_BSI_AuthAllow, ""},
	{"Device.WiFi.X_Charter_BandSteering.ActiveSteeringSettings.TxRateXingThreshold_UG", get_DWX_Charter_BSA_TxRateXingThreshold_UG, set_DWX_Charter_BSA_TxRateXingThreshold_UG, ""},
	{"Device.WiFi.X_Charter_BandSteering.ActiveSteeringSettings.RateRSSIXingThreshold_UG", get_DWX_Charter_BSA_RateRSSIXingThreshold_UG, set_DWX_Charter_BSA_RateRSSIXingThreshold_UG, ""},
	{"Device.WiFi.X_Charter_BandSteering.ActiveSteeringSettings.TxRateXingThreshold_DG", get_DWX_Charter_BSA_TxRateXingThreshold_DG, set_DWX_Charter_BSA_TxRateXingThreshold_DG, ""},
	{"Device.WiFi.X_Charter_BandSteering.ActiveSteeringSettings.RateRSSIXingThreshold_DG", get_DWX_Charter_BSA_RateRSSIXingThreshold_DG, set_DWX_Charter_BSA_RateRSSIXingThreshold_DG, ""},
	{"Device.WiFi.X_Charter_BandSteering.OffloadingSettings.MUAvgPeriod", get_DWX_Charter_BSO_MUAvgPeriod, set_DWX_Charter_BSO_MUAvgPeriod, ""},
	{"Device.WiFi.X_Charter_BandSteering.OffloadingSettings.MUOverloadThreshold_W2", get_DWX_Charter_BSO_MUOverloadThreshold_W2, set_DWX_Charter_BSO_MUOverloadThreshold_W2, ""},
	{"Device.WiFi.X_Charter_BandSteering.OffloadingSettings.MUOverloadThreshold_W5", get_DWX_Charter_BSO_MUOverloadThreshold_W5, set_DWX_Charter_BSO_MUOverloadThreshold_W5, ""},
	{"Device.WiFi.X_Charter_BandSteering.OffloadingSettings.MUSafetyThreshold_W2", get_DWX_Charter_BSO_MUSafetyThreshold_W2, set_DWX_Charter_BSO_MUSafetyThreshold_W2, ""},
	{"Device.WiFi.X_Charter_BandSteering.OffloadingSettings.MUSafetyThreshold_W5", get_DWX_Charter_BSO_MUSafetyThreshold_W5, set_DWX_Charter_BSO_MUSafetyThreshold_W5, ""},
	{"Device.WiFi.X_Charter_BandSteering.OffloadingSettings.OffloadingMinRSSI", get_DWX_Charter_BSO_OffloadingMinRSSI, set_DWX_Charter_BSO_OffloadingMinRSSI, ""},
	{"Device.WiFi.X_Charter_BandSteering.IAS.Enable_W2", get_DWX_Charter_BSI_ENABLEW2, set_DWX_Charter_BSI_ENABLEW2, ""},
	{"Device.WiFi.X_Charter_BandSteering.IAS.Enable_W5", get_DWX_Charter_BSI_ENABLEW5, set_DWX_Charter_BSI_ENABLEW5, ""},
	{"Device.WiFi.X_Charter_BandSteering.IAS.MaxPollutionTime", get_DWX_Charter_BSI_MAXPOLLUTIONTIME, set_DWX_Charter_BSI_MAXPOLLUTIONTIM, ""},
	{"Device.WiFi.X_Charter_BandSteering.IAS.UseBestEffort", get_DWX_Charter_BSI_USEBESTEFFORT, set_DWX_Charter_BSI_USEBESTEFFORT, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.SteeringProhibitTime", get_DWX_Charter_BSS_SteeringProhibitTime, set_DWX_Charter_BSS_SteeringProhibitTime, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.BTMSteeringProhibitShortTime", get_DWX_Charter_BSS_BTMSteeringProhibitShortTime, set_DWX_Charter_BSS_BTMSteeringProhibitShortTime, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.TSteering", get_DWX_Charter_BSS_TSteering, set_DWX_Charter_BSS_TSteering, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.InitialAuthRejCoalesceTime", get_DWX_Charter_BSS_InitialAuthRejCoalesceTime, set_DWX_Charter_BSS_InitialAuthRejCoalesceTime, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.AuthRejMax", get_DWX_Charter_BSS_AuthRejMax, set_DWX_Charter_BSS_AuthRejMax, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.SteeringUnfriendlyTime", get_DWX_Charter_BSS_SteeringUnfriendlyTime, set_DWX_Charter_BSS_SteeringUnfriendlyTime, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.MaxSteeringUnfriendly", get_DWX_Charter_BSS_MaxSteeringUnfriendly, set_DWX_Charter_BSS_MaxSteeringUnfriendly, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.TargetLowRSSIThreshold_W2", get_DWX_Charter_BSS_TargetLowRSSIThreshold_W2, set_DWX_Charter_BSS_TargetLowRSSIThreshold_W2, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.TargetLowRSSIThreshold_W5", get_DWX_Charter_BSS_TargetLowRSSIThreshold_W5, set_DWX_Charter_BSS_TargetLowRSSIThreshold_W5, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.BlacklistTime", get_DWX_Charter_BSS_BlacklistTime, set_DWX_Charter_BSS_BlacklistTime, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.BTMResponseTime", get_DWX_Charter_BSS_BTMResponseTime, set_DWX_Charter_BSS_BTMResponseTime, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.BTMAssociationTime", get_DWX_Charter_BSS_BTMAssociationTime, set_DWX_Charter_BSS_BTMAssociationTime, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.BTMAlsoBlacklist", get_DWX_Charter_BSS_BTMAlsoBlacklist, set_DWX_Charter_BSS_BTMAlsoBlacklist, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.BTMUnfriendlyTime", get_DWX_Charter_BSS_BTMUnfriendlyTime, set_DWX_Charter_BSS_BTMUnfriendlyTime, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.MaxBTMUnfriendly", get_DWX_Charter_BSS_MaxBTMUnfriendly, set_DWX_Charter_BSS_MaxBTMUnfriendly, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.MaxBTMActiveUnfriendly", get_DWX_Charter_BSS_MaxBTMActiveUnfriendly, set_DWX_Charter_BSS_MaxBTMActiveUnfriendly, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.MinRSSIBestEffort", get_DWX_Charter_BSS_MinRSSIBestEffort, set_DWX_Charter_BSS_MinRSSIBestEffort, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.StartInBTMActiveState", get_DWX_Charter_BSS_StartInBTMActiveState, set_DWX_Charter_BSS_StartInBTMActiveState, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.LowRSSIXingThreshold", get_DWX_Charter_BSS_LowRSSIXingThreshold, set_DWX_Charter_BSS_LowRSSIXingThreshold, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.Delay24GProbeRSSIThreshold", get_DWX_Charter_BSS_Delay24GProbeRSSIThreshold, set_DWX_Charter_BSS_Delay24GProbeRSSIThreshold, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.Delay24GProbeTimeWindow", get_DWX_Charter_BSS_Delay24GProbeTimeWindow, set_DWX_Charter_BSS_Delay24GProbeTimeWindowd, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteeringExecutorSettings.Delay24GProbeMinReqCount", get_DWX_Charter_BSS_Delay24GProbeMinReqCount, set_DWX_Charter_BSS_Delay24GProbeMinReqCount, ""},
	{"Device.WiFi.X_Charter_BandSteering.Estimator.RSSIDiff_EstW5FromW2", get_DWX_Charter_BSS_RSSIDiff_EstW5FromW2, set_DWX_Charter_BSS_RSSIDiff_EstW5FromW2, ""},
	{"Device.WiFi.X_Charter_BandSteering.Estimator.RSSIDiff_EstW2FromW5", get_DWX_Charter_BSS_RSSIDiff_EstW2FromW5, set_DWX_Charter_BSS_RSSIDiff_EstW2FromW5, ""},
	{"Device.WiFi.X_Charter_BandSteering.Estimator.ProbeCountThreshold", get_DWX_Charter_BSS_ProbeCountThreshold, set_DWX_Charter_BSS_ProbeCountThreshold, ""},
	{"Device.WiFi.X_Charter_BandSteering.Estimator.StatsSampleInterval", get_DWX_Charter_BSS_StatsSampleInterval, set_DWX_Charter_BSS_StatsSampleInterval, ""},
	{"Device.WiFi.X_Charter_BandSteering.Estimator.11kProhibitTimeShort", get_DWX_Charter_BSS_11kProhibitTimeShort, set_DWX_Charter_BSS_11kProhibitTimeShort, ""},
	{"Device.WiFi.X_Charter_BandSteering.Estimator.11kProhibitTimeLong", get_DWX_Charter_BSS_11kProhibitTimeLong, set_DWX_Charter_BSS_11kProhibitTimeLong, ""},
	{"Device.WiFi.X_Charter_BandSteering.Estimator.PhyRateScalingForAirtime", get_DWX_Charter_BSS_PhyRateScalingForAirtime, set_DWX_Charter_BSS_PhyRateScalingForAirtime, ""},
	{"Device.WiFi.X_Charter_BandSteering.Estimator.EnableContinuousThroughput", get_DWX_Charter_BSS_EnableContinuousThroughput, set_DWX_Charter_BSS_EnableContinuousThroughput, ""},
	{"Device.WiFi.X_Charter_BandSteering.Estimator.BcnrptActiveDuration", get_DWX_Charter_BSS_BcnrptActiveDuration, set_DWX_Charter_BSS_BcnrptActiveDuration, ""},
	{"Device.WiFi.X_Charter_BandSteering.Estimator.BcnrptPassiveDuration", get_DWX_Charter_BSS_BcnrptPassiveDuration, set_DWX_Charter_BSS_BcnrptPassiveDuration, ""},
	{"Device.WiFi.X_Charter_BandSteering.Estimator.FastPollutionDetectBufSize", get_DWX_Charter_BSS_FastPollutionDetectBufSize, set_DWX_Charter_BSS_FastPollutionDetectBufSize, ""},
	{"Device.WiFi.X_Charter_BandSteering.Estimator.NormalPollutionDetectBufSize", get_DWX_Charter_BSS_NormalPollutionDetectBufSize, set_DWX_Charter_BSS_NormalPollutionDetectBufSize, ""},
	{"Device.WiFi.X_Charter_BandSteering.Estimator.PollutionDetectThreshold", get_DWX_Charter_BSS_PollutionDetectThreshold, set_DWX_Charter_BSS_PollutionDetectThreshold, ""},
	{"Device.WiFi.X_Charter_BandSteering.Estimator.PollutionClearThreshold", get_DWX_Charter_BSS_PollutionClearThreshold, set_DWX_Charter_BSS_PollutionClearThreshold, ""},
	{"Device.WiFi.X_Charter_BandSteering.Estimator.InterferenceAgeLimit", get_DWX_Charter_BSS_InterferenceAgeLimit, set_DWX_Charter_BSS_InterferenceAgeLimit, ""},
	{"Device.WiFi.X_Charter_BandSteering.Estimator.IASLowRSSIThreshold", get_DWX_Charter_BSS_IASLowRSSIThreshold, set_DWX_Charter_BSS_IASLowRSSIThreshold, ""},
	{"Device.WiFi.X_Charter_BandSteering.Estimator.IASMaxRateFactor", get_DWX_Charter_BSS_IASMaxRateFactor, set_DWX_Charter_BSS_IASMaxRateFactor, ""},
	{"Device.WiFi.X_Charter_BandSteering.Estimator.IASMinDeltaBytes", get_DWX_Charter_BSS_IASMinDeltaBytes, set_DWX_Charter_BSS_IASMinDeltaBytes, ""},
	{"Device.WiFi.X_Charter_BandSteering.Estimator.IASMinDeltaPackets", get_DWX_Charter_BSS_IASMinDeltaPackets, set_DWX_Charter_BSS_IASMinDeltaPackets, ""},
	{"Device.WiFi.X_Charter_BandSteering.DiagLog.EnableLog", get_DWX_Charter_BSD_EnableLog, set_DWX_Charter_BSD_EnableLog, ""},
	{"Device.WiFi.X_Charter_BandSteering.DiagLog.LogServerIP", get_DWX_Charter_BSD_LogServerIP, set_DWX_Charter_BSD_LogServerIP, ""},
	{"Device.WiFi.X_Charter_BandSteering.DiagLog.LogServerPort", get_DWX_Charter_BSD_LogServerPort, set_DWX_Charter_BSD_LogServerPort, ""},
	{"Device.WiFi.X_Charter_BandSteering.DiagLog.LogLevelWlanIF", get_DWX_Charter_BSD_LogLevelWlanIF, set_DWX_Charter_BSD_LogLevelWlanIF, ""},
	{"Device.WiFi.X_Charter_BandSteering.DiagLog.LogLevelBandMon", get_DWX_Charter_BSD_LogLevelBandMon, set_DWX_Charter_BSD_LogLevelBandMon, ""},
	{"Device.WiFi.X_Charter_BandSteering.DiagLog.LogLevelStaDB", get_DWX_Charter_BSD_LogLevelStaDB, set_DWX_Charter_BSD_LogLevelStaDB, ""},
	{"Device.WiFi.X_Charter_BandSteering.DiagLog.LogLevelSteerExec", get_DWX_Charter_BSD_LogLevelSteerExec, set_DWX_Charter_BSD_LogLevelSteerExec, ""},
	{"Device.WiFi.X_Charter_BandSteering.DiagLog.LogLevelStaMon", get_DWX_Charter_BSD_LogLevelStaMon, set_DWX_Charter_BSD_LogLevelStaMon, ""},
	{"Device.WiFi.X_Charter_BandSteering.DiagLog.LogLevelEstimator", get_DWX_Charter_BSD_LogLevelEstimator, set_DWX_Charter_BSD_LogLevelEstimator, ""},
	{"Device.WiFi.X_Charter_BandSteering.DiagLog.LogLevelDiagLog", get_DWX_Charter_BSD_LogLevelDiagLog, set_DWX_Charter_BSD_LogLevelDiagLog, ""},
	{"Device.WiFi.X_Charter_BandSteering.APSteer.LowRSSIAPSteerThreshold_CAP", get_DWX_Charter_BSA_LowRSSIAPSteerThreshold_CAP, set_DWX_Charter_BSA_LowRSSIAPSteerThreshold_CAP, ""},
	{"Device.WiFi.X_Charter_BandSteering.APSteer.LowRSSIAPSteerThreshold_RE", get_DWX_Charter_BSA_LowRSSIAPSteerThreshold_RE, set_DWX_Charter_BSA_LowRSSIAPSteerThreshold_RE, ""},
	{"Device.WiFi.X_Charter_BandSteering.APSteer.APSteerToRootMinRSSIIncThreshold", get_DWX_Charter_BSA_APSteerToRootMinRSSIIncThreshold, set_DWX_Charter_BSA_APSteerToRootMinRSSIIncThreshold, ""},
	{"Device.WiFi.X_Charter_BandSteering.APSteer.APSteerToLeafMinRSSIIncThreshold", get_DWX_Charter_BSA_APSteerToLeafMinRSSIIncThreshold, set_DWX_Charter_BSA_APSteerToLeafMinRSSIIncThreshold, ""},
	{"Device.WiFi.X_Charter_BandSteering.APSteer.APSteerToPeerMinRSSIIncThreshold", get_DWX_Charter_BSA_APSteerToPeerMinRSSIIncThreshold, set_DWX_Charter_BSA_APSteerToPeerMinRSSIIncThreshold, ""},
	{"Device.WiFi.X_Charter_BandSteering.APSteer.DownlinkRSSIThreshold_W5", get_DWX_Charter_BSA_DownlinkRSSIThreshold_W5, set_DWX_Charter_BSA_DownlinkRSSIThreshold_W5, ""},
	{"Device.WiFi.X_Charter_BandSteering.StaMonitor.RSSIMeasureSamples_W2", get_DWX_Charter_BSS_RSSIMeasureSamples_W2, set_DWX_Charter_BSS_RSSIMeasureSamples_W2, ""},
	{"Device.WiFi.X_Charter_BandSteering.StaMonitor.RSSIMeasureSamples_W5", get_DWX_Charter_BSS_RSSIMeasureSamples_W5, set_DWX_Charter_BSS_RSSIMeasureSamples_W5, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteerAlg_Adv.MinTxRateIncreaseThreshold", get_DWX_Charter_BSS_MinTxRateIncreaseThreshold, set_DWX_Charter_BSS_MinTxRateIncreaseThreshold, ""},
	{"Device.WiFi.X_Charter_BandSteering.SteerAlg_Adv.MaxSteeringTargetCount", get_DWX_Charter_BSS_MaxSteeringTargetCount, set_DWX_Charter_BSS_MaxSteeringTargetCount, ""},
	{"Device.WiFi.X_Charter_BandSteering.BandMonitor.ProbeCountThreshold", get_DWX_Charter_BSB_ProbeCountThreshold, set_DWX_Charter_BSB_ProbeCountThreshold, ""},
	{"Device.WiFi.X_Charter_BandSteering.BandMonitor.MUCheckInterval_W2", get_DWX_Charter_BSB_MUCheckInterval_W2, set_DWX_Charter_BSB_MUCheckInterval_W2, ""},
	{"Device.WiFi.X_Charter_BandSteering.BandMonitor.MUCheckInterval_W5", get_DWX_Charter_BSB_MUCheckInterval_W5, set_DWX_Charter_BSB_MUCheckInterval_W5, ""},
	{"Device.WiFi.X_Charter_BandSteering.BandMonitor.MUReportPeriod", get_DWX_Charter_BSB_MUReportPeriod, set_DWX_Charter_BSB_MUReportPeriod, ""},
	{"Device.WiFi.X_Charter_BandSteering.BandMonitor.LoadBalancingAllowedMaxPeriod", get_DWX_Charter_BSB_LoadBalancingAllowedMaxPeriod, set_DWX_Charter_BSB_LoadBalancingAllowedMaxPeriod, ""},
	{"Device.WiFi.X_Charter_BandSteering.BandMonitor.NumRemoteChannels", get_DWX_Charter_BSB_NumRemoteChannels, set_DWX_Charter_BSB_NumRemoteChannels, ""},
	...
	{"Device.WiFi.Radio.template.CurrentOperatingChannelBandwidth", get_DWRt_CurrentOperatingChannelBandwidth, 0, ""},
	...
	{"Device.WiFi.AccessPoint.template.Security.MFPConfig", get_DWAtS_MFPConfig, set_DWAtS_MFPConfig, ""},
	{"Device.WiFi.AccessPoint.template.Security.X_TWC_COM_PreSharedKey", get_DWAtS_X_TWC_COM_PreSharedKey, set_DWAtS_X_TWC_COM_PreSharedKey, ""},
	{"Device.WiFi.AccessPoint.template.Security.X_TWC_COM_PreSharedKeySHA1", get_DWAtS_X_TWC_COM_PreSharedKeySHA1, 0, ""},
	{"Device.WiFi.AccessPoint.template.Security.X_TWC_COM_KeyPassPhrase", get_DWAtS_X_TWC_COM_KeyPassPhrase, set_DWAtS_X_TWC_COM_KeyPassPhrase, ""},
	{"Device.WiFi.AccessPoint.template.Security.X_TWC_COM_KeyPassPhraseSHA1", get_DWAtS_X_TWC_COM_KeyPassPhraseSHA1, 0, ""},
	...
	{"Device.WiFi.AccessPoint.template.WPS.Version", get_DWAtW_Version, 0, ""},
	{"Device.WiFi.AccessPoint.template.WPS.Status", get_DWAtW_Status, 0, ""},
	{"Device.WiFi.AccessPoint.template.WPS.PIN", get_DWAtW_PIN, 0, ""},
	{"Device.WiFi.AccessPoint.template.AssociatedDevice.template.MACAddress", get_DWAtAt_MACAddress, 0, ""},
	{"Device.WiFi.AccessPoint.template.AssociatedDevice.template.OperatingStandard", get_DWAtAt_OperatingStandard, 0, ""},
	...
	{"Device.WiFi.EndPoint.template.Security.MFPConfig", get_DWEtS_MFPConfig, set_DWEtS_MFPConfig, ""},
	...
	{"Device.WiFi.EndPoint.template.WPS.Version", get_DWEtW_Version, 0, ""},
	{"Device.WiFi.EndPoint.template.WPS.Status", get_DWEtW_Status, 0, ""},
	{"Device.WiFi.EndPoint.template.WPS.PIN", get_DWEtW_PIN, 0, ""},
	...
	{"Device.IP.Interface.template.IPv4Address.template.SubnetMask", get_DIItIt_SubnetMask, set_DIItIt_SubnetMask, ""},
	...
	{"Device.IP.Interface.template.IPv6Address.template.Alias", get_DIItIt_Alias_2241, set_DIItIt_Alias_2241, ""},
	{"Device.IP.Interface.template.IPv6Address.template.IPAddress", get_DIItIt_IPAddress_2242, set_DIItIt_IPAddress_2242, ""},
	...
	{"Device.IP.Interface.template.IPv6Address.template.PreferredLifetime", get_DIItIt_PreferredLifetime, set_DIItIt_PreferredLifetime, ""},
	{"Device.IP.Interface.template.IPv6Address.template.ValidLifetime", get_DIItIt_ValidLifetime, set_DIItIt_ValidLifetime, ""},
	...
	{"Device.IP.Diagnostics.DownloadDiagnostics.DSCP", get_DIDD_DSCP, set_DIDD_DSCP, ""},
	...
	{"Device.IP.Diagnostics.UDPEchoConfig.PacketsReceived", get_DIDU_PacketsReceived, set_DIDU_PacketsReceived, ""},
	{"Device.IP.Diagnostics.UDPEchoConfig.PacketsResponded", get_DIDU_PacketsResponded, set_DIDU_PacketsResponded, ""},
	{"Device.IP.Diagnostics.UDPEchoConfig.BytesReceived", get_DIDU_BytesReceived, set_DIDU_BytesReceived, ""},
	{"Device.IP.Diagnostics.UDPEchoConfig.BytesResponded", get_DIDU_BytesResponded, set_DIDU_BytesResponded, ""},
	{"Device.IP.Diagnostics.UDPEchoConfig.TimeFirstPacketReceived", get_DIDU_TimeFirstPacketReceived, set_DIDU_TimeFirstPacketReceived, ""},
	{"Device.IP.Diagnostics.UDPEchoConfig.TimeLastPacketReceived", get_DIDU_TimeLastPacketReceived, set_DIDU_TimeLastPacketReceived, ""},
	...
	{"Device.GRE.Tunnel.FilterNumberOfEntries", get_DGT_FilterNumberOfEntries, 0, ""},
	{"Device.GRE.Tunnel.TunnelNumberOfEntries", get_DGT_TunnelNumberOfEntries, 0, ""},
	...
	{"Device.GRE.Tunnel.template.Interface.template.Name", get_DGTtIt_Name, set_DGTtIt_Name, ""},
	...
	{"Device.MAP.Domain.template.Rule.template.IsFMR", get_DMDtRt_IsFMR, 0, ""},
	...
	{"Device.Hosts.Host.template.ActiveLastChange", get_DHHt_ActiveLastChange, 0, ""},
	...
	{"Device.DHCPv4.Client.template.Interface", get_DDCt_V4_Interface, 0, ""},
	...
	{"Device.Users.User.template.X_CHARTER_COM_RemoteCLAccessCapable", get_DUUt_X_CHARTER_COM_RemoteCLAccessCapable, set_DUUt_X_CHARTER_COM_RemoteCLAccessCapable, ""},
	{"Device.Users.User.template.X_CHARTER_COM_LocalCLAccessCapable", get_DUUt_X_CHARTER_COM_LocalCLAccessCapable, set_DUUt_X_CHARTER_COM_LocalCLAccessCapable, ""},
	{"Device.Users.User.template.X_CHARTER_COM_Password", get_DUUt_X_CHARTER_COM_Password, set_DUUt_X_CHARTER_COM_Password, ""},
	...
	{"Device.XMPP.Connection.template.Enable", get_DXCt_Enable, set_DXCt_Enable, "0"},
	...
	{"Device.XMPP.Connection.template.KeepAliveInterval", get_DXCt_KeepAliveInterval, set_DXCt_KeepAliveInterval, "-1"},
	{"Device.XMPP.Connection.template.ServerConnectAttempts", get_DXCt_ServerConnectAttempts, set_DXCt_ServerConnectAttempts, "16"},
	{"Device.XMPP.Connection.template.ServerRetryInitialInterval", get_DXCt_ServerRetryInitialInterval, set_DXCt_ServerRetryInitialInterval, "60"},
	{"Device.XMPP.Connection.template.ServerRetryIntervalMultiplier", get_DXCt_ServerRetryIntervalMultiplier, set_DXCt_ServerRetryIntervalMultiplier, "2000"},
	{"Device.XMPP.Connection.template.ServerRetryMaxInterval", get_DXCt_ServerRetryMaxInterval, set_DXCt_ServerRetryMaxInterval, "30720"},
	{"Device.XMPP.Connection.template.UseTLS", get_DXCt_UseTLS, set_DXCt_UseTLS, "0"},
	...
	{"Device.X_Charter.RIP.template.Enable", get_DXCRE_Enable, set_DXCRE_Enable, ""},
	{"Device.X_Charter.RIP.template.AdvertisementInterval", get_DXCRA_AdvertisementInterval, set_DXCRA_AdvertisementInterval, ""},
	{"Device.X_Charter.RIP.template.Alias", get_DXCRA_Alias, set_DXCRA_Alias, ""},
	{"Device.X_Charter.RIP.template.AuthenticationMode", get_DXCRA_AuthenticationMode, set_DXCRA_AuthenticationMode, ""},
	{"Device.X_Charter.RIP.template.Key", get_DXCRK_Key, set_DXCRK_Key, ""},
	{"Device.X_Charter.RIP.template.Keystring", get_DXCRK_Keystring, set_DXCRK_Keystring, ""},
	{"Device.X_Charter.RIP.template.RIPIP", get_DXCRR_RIPIP, set_DXCRR_RIPIP, ""},
	{"Device.X_Charter.RIP.template.RIPSubnet", get_DXCRR_RIPSubnet, set_DXCRR_RIPSubnet, ""},
	{"Device.X_Charter.RIP.template.RIPDefaultGateway", get_DXCRR_RIPDefaultGateway, set_DXCRR_RIPDefaultGateway, ""},
	{"Device.X_Charter.Watchdog.Enable", get_DXW_Enable, set_DXW_Enable, ""},
	{"Device.X_Charter.Watchdog.DestinationIPDes", get_DXW_DestinationIPDes, set_DXW_DestinationIPDes, ""},
	...
	{"Device.X_Charter.Watchdog.MissedEchoCount", get_DXW_MissedEchoCount, set_DXW_MissedEchoCount, ""},
	{"Device.X_Charter.Watchdog.RebootThreshold", get_DXW_RebootThreshold, set_DXW_RebootThreshold, ""},
	{"Device.WiFi.Radio.template.X_Charter_SpectralEnable", get_DWRt_X_Charter_SpectralEnable,  set_DWRt_X_Charter_SpectralEnable, ""},
	{"Device.WiFi.Radio.template.X_Charter_AutoChannelRssiThreshold", get_DWRt_X_Charter_AutoChannelRssiThreshold,  set_DWRt_X_Charter_AutoChannelRssiThreshold, ""},
	{"Device.DynamicDNS.ClientNumberOfEntries", get_DD_ClientNumberOfEntries_7072, 0, ""},
	...
	{"Device.DynamicDNS.Client.template.Enable", get_DDCt_Enable_7102, set_DDCt_Enable_7102, ""},
	{"Device.DynamicDNS.Client.template.Status", get_DDCt_Status_7104, 0, ""},
	{"Device.DynamicDNS.Client.template.Alias", get_DDCt_Alias_7105, set_DDCt_Alias_7105, "cpe-wan-template-ddns"},
	...
	{"Device.DynamicDNS.Client.template.Interface", get_DDCt_Interface_7110, set_DDCt_Interface_7110, ""},
	...
	{"Device.DynamicDNS.Server.template.Alias", get_DDSt_Alias_7152, set_DDSt_Alias_7152, ""},
	...
	{"Device.X_CHARTER_COM_OperatorInterface.RemoteAccess.Enable", get_DXR_Enable, set_DXR_Enable, ""},
	{"Device.X_CHARTER_COM_OperatorInterface.RemoteAccess.Port", get_DXR_Port, set_DXR_Port, ""},
	{"Device.X_CHARTER_COM_OperatorInterface.RemoteAccess.SupportedProtocols", get_DXR_SupportedProtocols, 0, ""},
	{"Device.X_CHARTER_COM_OperatorInterface.RemoteAccess.Protocol", get_DXR_Protocol, set_DXR_Protocol, ""},
	{"Device.X_CHARTER_COM_OperatorInterface.LocalAccess.Enable", get_DXL_Enable, set_DXL_Enable, ""},
	{"Device.X_CHARTER_COM_OperatorInterface.LocalAccess.Port", get_DXL_Port, set_DXL_Port, ""},
	{"Device.X_CHARTER_COM_OperatorInterface.LocalAccess.SupportedProtocols", get_DXL_SupportedProtocols, 0, ""},
	{"Device.X_CHARTER_COM_OperatorInterface.LocalAccess.Protocol", get_DXL_Protocol, set_DXL_Protocol, ""},
	{"Device.X_Charter.CPUReboot.Enable", get_DXC_Enable, set_DXC_Enable, ""},
	{"Device.X_Charter.CPUReboot.CPUThreshold", get_DXC_CPUThreshold, set_DXC_CPUThreshold, ""},
	{"Device.X_Charter.CPUReboot.CPUtimer", get_DXC_CPUtimer, set_DXC_CPUtimer, ""},
	{"Device.X_Charter.MemoryReboot.Enable", get_DXM_Enable, set_DXM_Enable, ""},
	{"Device.X_Charter.MemoryReboot.MemoryThreshold", get_DXM_MemoryThreshold, set_DXM_MemoryThreshold, ""},
	{"Device.X_Charter.MemoryReboot.Memorytimer", get_DXM_Memorytimer, set_DXM_Memorytimer, ""},
	{"",0,0,""}
};
