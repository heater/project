...
#define FLAG_NEED_FACTORY_RESET ".FLAG_NEED_FACTORY_RESET"
#define FLAG_BOOTSTRAP ".FLAG_BOOTSTRAP"
#define FLAG_BOOT "/var/.FLAG_BOOT"
#define FLAG_ACS_URL_CHANGED ".FLAG_ACS_URL_CHANGED"
#define FLAG_TREE_TO_XML "/var/.FLAG_TREE_TO_XML"
